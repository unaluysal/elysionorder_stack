...
namespace ElysionOrder.Infrastructure.Data.Migrations
{
    ...
    partial class ElysionOrderDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.BillItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("BillItems", "ElysionOrder");
                });
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Expenses", "ElysionOrder");
                });

            modelBuilder.Entity("ElysionOrder.Domain.Entitys.ExpenseType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ExpenseTypes", "ElysionOrder");
                });
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.PaymentWay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("PaymentWays", "ElysionOrder");
                });
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.BillItem", b =>
                {
                    b.HasOne("ElysionOrder.Domain.Entitys.Bill", "Bill")
                        .WithMany()
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.Expense", b =>
                {
                    b.HasOne("ElysionOrder.Domain.Entitys.ExpenseType", "ExpenseType")
                        .WithMany()
            ...
            modelBuilder.Entity("ElysionOrder.Domain.Entitys.Payment", b =>
                {
                    ...
                    b.HasOne("ElysionOrder.Domain.Entitys.PaymentWay", "PaymentWay")
                        .WithMany()
